...
int pwm1 = 0, pwm2 = 0, dir1 = 0, dir2 = 0;
...
void updateMotorPWM() {
    ...
    dir1 = (v1_target > 0) ? 1 : (v1_target < 0 ? -1 : 0);
    dir2 = (v2_target > 0) ? 1 : (v2_target < 0 ? -1 : 0);

    ff1 = (dir1 > 0) ? pwmFromVelocity(v1_target) : pwmFromVelocityReverse(-v1_target);
    ff2 = (dir2 > 0) ? pwmFromVelocity(v2_target) : pwmFromVelocityReverse(-v2_target);
    pwm1 = limitPWM(ff1 + pid1);
    pwm2 = limitPWM(ff2 + pid2);
